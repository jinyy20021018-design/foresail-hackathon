          ...
          {hazardCards.map((h) => {
            ...
            return (
              ...
              >
                ...
                {h.attribution?.attribution_note && <span className="haz-attr" title={h.attribution.attribution_note}>{h.attribution.attribution_note}</span>}
                <div className="haz-conf" title={`${confPct}% confidence${h.corroborated ? `, ${h.sources?.length ?? 0} sources corroborate` : ", single source"}`}>
                  <span className="haz-conf-track"><span className="haz-conf-fill" style={{ width: `${confPct}%` }} /></span>
                  <span className="haz-conf-val">{confPct}%</span>
